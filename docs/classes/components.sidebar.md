[@guardian/prosemirror-typerighter](../README.md) › [Globals](../globals.md) › [components](../modules/components.md) › [Sidebar](components.sidebar.md)
...
\+ **new Sidebar**(`props?`: P, `context?`: any): *[Sidebar](components.sidebar.md)*
